...
public class Edit_Friends extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_edit_friend);
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (awesomeValidation.validate()) {
                    String message = new Friend(context).edit(fname,contact,descriptions,district_id, id);
                    Toast.makeText(context,message,Toast.LENGTH_SHORT).show();

                    if (message.equals("friend cases updated!")){
    ...
    private void setAll(int id){
        try {
            Cursor cursor = new Friend(context).select(id);
            if (cursor.moveToFirst()) {
                do {
                    input_fname.setText(cursor.getString(cursor.getColumnIndex(Constants.config.FRIEND_NAME)));
                    input_description.setText(cursor.getString(cursor.getColumnIndex(Constants.config.FRIEND_TYPE)));
