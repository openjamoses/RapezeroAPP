...
public class Edit_Police extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_edit_police);
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (awesomeValidation.validate()) {
                    String message = new Police(context).edit(fname, contact, descriptions, district_id, id);
                    Toast.makeText(context, message, Toast.LENGTH_SHORT).show();

                    if (message.equals("police cases updated!")) {
    ...
    private void setAll(int id){
        try {
            Cursor cursor = new Police(context).select(id);
            if (cursor.moveToFirst()) {
                do {
                    input_fname.setText(cursor.getString(cursor.getColumnIndex(Constants.config.POLICE_NAME)));
                    input_description.setText(cursor.getString(cursor.getColumnIndex(Constants.config.POLICE_TYPE)));
