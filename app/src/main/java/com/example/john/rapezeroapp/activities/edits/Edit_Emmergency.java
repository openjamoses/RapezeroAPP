...
public class Edit_Emmergency extends AppCompatActivity {
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (awesomeValidation.validate()) {
                    String message = new Emmergency(context).edit(fname,contact,descriptions,district_id,id);
                    Toast.makeText(context,message,Toast.LENGTH_SHORT).show();

                    if (message.equals("emmergency cases updated!")){
                        startActivity(new Intent(context,Emmergency_Activity.class));
                        finish();
                    }
                }
            }
    ...
    private void setAll(int id){
        try {
            Cursor cursor = new Emmergency(context).select(id);
