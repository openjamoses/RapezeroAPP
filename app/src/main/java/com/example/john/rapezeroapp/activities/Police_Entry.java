...
public class Police_Entry extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_police_entry);
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (awesomeValidation.validate()) {
                    String message = new Police(context).save(fname,contact,descriptions,district_id);
                    Toast.makeText(context,message,Toast.LENGTH_SHORT).show();

                    if (message.equals("police cases saved!")){
